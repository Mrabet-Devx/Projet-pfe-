...
<section>
        ...
        <div class="row" >
            ...
            <div class="col-md-5" style="padding-bottom: 20px;background-color:darkgrey;border-radius: 20px;margin-right: 10px;margin-top: 20px;">
               <h1><u><center>Produits plus Vendu</center></u></h1>
...
<script>
  ...
  <?php
  $getcat = mysqli_query($conn, "SELECT * FROM products WHERE product_category IN(SELECT DISTINCT product_category FROM products) GROUP BY `products`.`product_category` LIMIT 6");
  $labels = "";
  $stats="";
  ...
  new Chart(ctx, {
    ...
    options: {
              ...
              <h1><u><center>Produits mois Vendu</center></u></h1>
             <div>
